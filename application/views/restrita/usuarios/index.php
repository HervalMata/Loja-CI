					...
					<div class="card">
						<div class="card-header d-block">
							...
							<a class="btn btn-primary float-right"
							   href="<?php echo base_url('restrita/usuarios/core'); ?>">Cadastrar</a>
						</div>
						<div class="card-body">
								...
								<table class="table table-striped dataTable">
									...
									<?php foreach ($usuarios as $usuario): ?>
										<tr>
											...
											<td>
												<?php echo($this->ion_auth->is_admin($usuario->id) ? 'Administrador' : 'Cliente'); ?>
											</td>
											<td>
											...
											<td>
												...
												<a href="<?php echo base_url('restrita/usuarios/delete/' . $usuario->id) ?>"
												   class="btn btn-icon btn-danger delete"
												   data-confirm="Tem certeza da exclusão?"><i class="fa fa-trash"></i>
												</a>
											</td>
